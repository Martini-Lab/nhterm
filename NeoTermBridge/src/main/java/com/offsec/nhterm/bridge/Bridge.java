...
public class Bridge {
  ...
  public static Intent createExecutePwnIntent(String command) {
    return createExecuteIntent(SessionId.NEW_SESSION, "/data/data/hilled.pwnterm/files/usr/bin/bash", "'" + command + "'");
  }

  // Android SU
  @SuppressLint("SdCardPath")
  public static Intent createExecuteSuIntent(String command) {
    return createExecuteIntent(SessionId.NEW_SESSION, "/data/data/hilled.pwnterm/files/usr/bin/android-su", command);
  }

  // NetHunter
  @SuppressLint("SdCardPath")
  public static Intent createExecuteNHIntent(String command) {
    return createExecuteIntent(SessionId.NEW_SESSION, "/data/data/hilled.pwnterm/files/usr/bin/kali", command);
  }
